class StarshipsController < ApplicationController
	...
	def index
		...
		if params[:model_search] && params[:model_search] != ""
			@starships = StarshipSearch.filter_by(:model, @starships, params[:model_search])
		end
		
		if params[:manufacturer_search] && params[:manufacturer_search] != ""
			@starships = StarshipSearch.filter_by(:manufacturer, @starships, params[:manufacturer_search])
		end
